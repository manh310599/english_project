...
abstract class $ImportStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({ExportImportFile exportImportFile, List<List<dynamic>>? data});
}
...
class _$ImportStateImpl extends _ImportState {
  const _$ImportStateImpl(
      ...
      final List<List<dynamic>>? data = null})
      : _data = data,
        super._();
  ...
  @override
  String toString() {
    return 'ImportState(exportImportFile: $exportImportFile, data: $data)';
  }
...
abstract class _ImportState extends ImportState {
  const factory _ImportState(
      {final ExportImportFile exportImportFile,
      final List<List<dynamic>>? data}) = _$ImportStateImpl;
